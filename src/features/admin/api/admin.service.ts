...
async function updateSetting(
  ...
  return (
    await apiClient.put<SettingsUpdateResponse>(
...
async function getUsers(
  ...
  if (query.realm) params.realm = query.realm;
...
async function revealUserAddress(
  ...
  return (
    await apiClient.post<UserAddressDetail>(
...
async function revealUserNationalId(
  ...
  return (
    await apiClient.post<UserNationalIdRevealResponse>(
...
async function createUser(
  ...
  return (await apiClient.post<CreateUserResponse>("/users", payload)).data;
}
...
async function deactivateAccount(
  ...
  return (
    await apiClient.post<DeactivateStudentAccountResponse>(
      `/users/${id}/deactivate`,
      payload,
    )
  ).data;
...
async function reactivateAccount(
  ...
  return (
    await apiClient.post<AccountReactivateResponse>(`/users/${id}/reactivate`)
  ).data;
}
...
async function getRoleGroups(
  ...
  const endpoint =
    query.scope === "council"
      ? "/users/council-role-groups"
      : "/users/role-groups";
  return normalizePaginatedResponse<RoleDefinition>(
...
async function createRoleGroup(
  ...
  scope: "school" | "council" = "school",
): Promise<void> {
  const endpoint =
    scope === "council" ? "/users/council-role-groups" : "/users/role-groups";
...
async function updateRoleGroup(
  ...
  const endpoint =
    scope === "council" ? "/users/council-role-groups" : "/users/role-groups";
  await apiClient.put(`${endpoint}/${encodeURIComponent(roleName)}`, payload);
}
async function deleteRoleGroup(
  ...
  const endpoint =
    scope === "council" ? "/users/council-role-groups" : "/users/role-groups";
  await apiClient.delete(`${endpoint}/${encodeURIComponent(roleName)}`);
}
