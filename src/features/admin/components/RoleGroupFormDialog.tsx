...
export function RoleGroupFormDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader>
          <DialogTitle>{isEdit ? "แก้ไขกลุ่มสิทธิ์" : "เพิ่มกลุ่มสิทธิ์"}</DialogTitle>
        </DialogHeader>
        ...
        <Form form={form} onSubmit={handleSubmit}>
          <DialogBody>
            ...
            <div className="mt-2">
              ...
              <div className="grid max-h-56 grid-cols-1 gap-2 overflow-y-auto rounded-lg border border-slate-100 bg-slate-50 p-3 sm:grid-cols-2">
