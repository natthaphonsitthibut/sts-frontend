      ...
      <section className="araid-screen-enter w-full max-w-md rounded-3xl bg-white px-6 py-10 text-center shadow-2xl sm:px-10">
        ...
        {!challengeToken ? (
          ...
          <div className="mt-8 flex flex-col items-center">
            ...
            <h1 className="mt-4 text-xl font-bold text-araid-brand-deep">ยืนยันสำเร็จ</h1>
          ...
          <div className="mt-8">
            <ShieldCheck className="mx-auto size-14 text-danger" aria-hidden="true" />
            <h1 className="mt-4 text-xl font-bold text-araid-brand-deep">ยืนยันไม่สำเร็จ</h1>
          ...
          <div className="mt-8 flex flex-col items-center">
            <LoaderCircle className="size-12 animate-spin text-araid-action motion-reduce:animate-none" aria-hidden="true" />
            <h1 className="mt-4 text-xl font-bold text-araid-brand-deep">กำลังยืนยันตัวตน</h1>
