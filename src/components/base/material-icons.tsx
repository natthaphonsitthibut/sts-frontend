...
/** Material "domain" glyph — a school/building, distinct from the graduation-cap brand mark. */
export const SchoolBuildingIcon = createMaterialIcon(
  "SchoolBuildingIcon",
  <path d="M12 7V3H2v18h20V7H12zM6 19H4v-2h2v2zm0-4H4v-2h2v2zm0-4H4V9h2v2zm0-4H4V5h2v2zm4 12H8v-2h2v2zm0-4H8v-2h2v2zm0-4H8V9h2v2zm0-4H8V5h2v2zm10 12h-8v-2h2v-2h-2v-2h2v-2h-2V9h8v10zm-2-8h-2v2h2v-2zm0 4h-2v2h2v-2z" />,
);

export const TimelineIcon = createMaterialIcon(
  "TimelineIcon",
  <>
    <g>
      <g>
...
export const CalendarTodayIcon = createMaterialIcon(
  "CalendarTodayIcon",
  <>
    <path d="M20 3h-1V1h-2v2H7V1H5v2H4c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 18H4V8h16v13z" />
  </>,
);
export const EventAvailableIcon = createMaterialIcon(
  "EventAvailableIcon",
  <>
...
export const BarChartIcon = createMaterialIcon(
  "BarChartIcon",
  <>
    <g>
      <g>
...
export const EqualizerIcon = createMaterialIcon(
  "EqualizerIcon",
  <>
    <path d="M10 20h4V4h-4v16zm-6 0h4v-8H4v8zM16 9v11h4V9h-4z" />
  </>,
);
export const AssignmentTurnedInIcon = createMaterialIcon(
  "AssignmentTurnedInIcon",
  <>
    <path d="M19 3h-4.18C14.4 1.84 13.3 1 12 1c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm-2 14l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z" />
  </>,
);
export const FactCheckIcon = createMaterialIcon(
  "FactCheckIcon",
  <>
...
export const FileDownloadIcon = createMaterialIcon(
  "FileDownloadIcon",
  <>
    <path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z" />
  </>,
);
export const EditIcon = createMaterialIcon(
  "EditIcon",
  <>
    <path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z" />
  </>,
);
export const UploadFileIcon = createMaterialIcon(
  "UploadFileIcon",
  <>
...
export const TableChartIcon = createMaterialIcon(
  "TableChartIcon",
  <>
...
export const FolderSpecialIcon = createMaterialIcon(
  "FolderSpecialIcon",
  <>
...
export const VolunteerActivismIcon = createMaterialIcon(
...
export const HomeIcon = createMaterialIcon(
  "HomeIcon",
  <>
    <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z" />
  </>,
);
export const VpnKeyIcon = createMaterialIcon(
  "VpnKeyIcon",
  <>
    <path d="M12.65 10C11.83 7.67 9.61 6 7 6c-3.31 0-6 2.69-6 6s2.69 6 6 6c2.61 0 4.83-1.67 5.65-4H17v4h4v-4h2v-4H12.65zM7 14c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z" />
  </>,
);
export const LinkIcon = createMaterialIcon(
  "LinkIcon",
  <>
    <path d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5z" />
  </>,
);
export const AddLinkIcon = createMaterialIcon(
  "AddLinkIcon",
  <>
...
export const PlaceIcon = createMaterialIcon(
  "PlaceIcon",
  <>
    <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" />
  </>,
);
export const NotificationsIcon = createMaterialIcon(
  "NotificationsIcon",
  <>
    <path d="M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" />
  </>,
);
export const SendIcon = createMaterialIcon(
  "SendIcon",
  <>
...
export const HowToRegIcon = createMaterialIcon(
  "HowToRegIcon",
  <>
    <g fillRule="evenodd">
...
export const PersonIcon = createMaterialIcon(
  "PersonIcon",
  <>
    <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" />
  </>,
);
export const PersonAddIcon = createMaterialIcon(
  "PersonAddIcon",
  <>
...
export const GroupIcon = createMaterialIcon(
  "GroupIcon",
  <>
    <path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z" />
  </>,
);
export const GroupsIcon = createMaterialIcon(
  "GroupsIcon",
  <>
    <g>
...
export const ApartmentIcon = createMaterialIcon(
  "ApartmentIcon",
  <>
...
export const ChildCareIcon = createMaterialIcon(
  "ChildCareIcon",
  <>
    <circle cx="14.5" cy="10.5" r="1.25" />
    <circle cx="9.5" cy="10.5" r="1.25" />
    <path d="M16.1 14H7.9c.8 1.75 2.45 3 4.1 3s3.3-1.25 4.1-3zm6.84-1.34c.04-.21.06-.43.06-.66s-.02-.45-.06-.66c-.25-1.51-1.36-2.74-2.81-3.17-.53-1.12-1.28-2.1-2.19-2.91C16.36 3.85 14.28 3 12 3s-4.36.85-5.94 2.26c-.92.81-1.67 1.8-2.19 2.91-1.45.43-2.56 1.65-2.81 3.17-.04.21-.06.43-.06.66s.02.45.06.66c.25 1.51 1.36 2.74 2.81 3.17.52 1.11 1.27 2.09 2.17 2.89C7.62 20.14 9.71 21 12 21s4.38-.86 5.97-2.28c.9-.8 1.65-1.79 2.17-2.89 1.44-.43 2.55-1.65 2.8-3.17zM19 14c-.1 0-.19-.02-.29-.03-.2.67-.49 1.29-.86 1.86C16.6 17.74 14.45 19 12 19s-4.6-1.26-5.85-3.17c-.37-.57-.66-1.19-.86-1.86-.1.01-.19.03-.29.03-1.1 0-2-.9-2-2s.9-2 2-2c.1 0 .19.02.29.03.2-.67.49-1.29.86-1.86C7.4 6.26 9.55 5 12 5s4.6 1.26 5.85 3.17c.37.57.66 1.19.86 1.86.1-.01.19-.03.29-.03 1.1 0 2 .9 2 2s-.9 2-2 2z" />
  </>,
);
export const ChatBubbleIcon = createMaterialIcon(
  "ChatBubbleIcon",
  <>
    <path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z" />
  </>,
);
export const SecurityIcon = createMaterialIcon(
  "SecurityIcon",
  <>
...
export const ImportExportIcon = createMaterialIcon(
  "ImportExportIcon",
  <>
    <path d="M9 3 5 6.99h3V14h2V6.99h3L9 3zm7 14.01V10h-2v7.01h-3L15 21l4-3.99h-3z" />
  </>,
);
export const AppsIcon = createMaterialIcon(
  "AppsIcon",
  <>
