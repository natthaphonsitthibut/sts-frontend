  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 lg:flex-col lg:gap-2">
        <div
          aria-hidden="true"
          className={connectPrev ? "hidden w-px flex-1 bg-slate-200 lg:-mt-5 lg:block" : "hidden flex-1 lg:block"}
        />
        <span
          className={
            active
        ...
        <div
          aria-hidden="true"
          className={connectNext ? "hidden w-px flex-1 bg-slate-200 lg:-mb-5 lg:block" : "hidden flex-1 lg:block"}
        />
      </div>
      <div className={active ? "rounded-xl border border-primary bg-brand-active p-4 sm:p-5" : "rounded-xl border border-slate-200 bg-slate-50 p-4 sm:p-5"}>
        {children}
      </div>
    </div>
  );
