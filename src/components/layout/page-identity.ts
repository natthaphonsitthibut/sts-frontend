...
export const PAGE_IDENTITIES = {
  ...
  "/student-risk-report/teacher-reports": createIdentity("ข้อสังเกตจากครู", "chart-line"),
  "/student-risk-report/home-visit-requests": createIdentity("คำขอเยี่ยมบ้าน", "chart-line"),
